...
<link rel="stylesheet" href="resources/umesg.css" type="text/css">
EOF;
...
<?php
echo '<p>'.htmlspecialchars($this->t($this->data['dictDescr'], $this->data['parameters'])).'</p>';
...
?>
    ...
    <form action="<?php echo htmlspecialchars($this->data['errorReportAddress']); ?>" method="post">
        ...
        <p>
            ...
            <button class="btn btn-lg btn-primary btn-block btn-signin"type="submit" name="send" class="btn"><?php echo $this->t('report_submit'); ?></button>
        </p>
    </form>
    <?php
}
